...
export default function HomePage() {
    return (
        <div className="min-h-screen bg-gradient-to-r from-purple-500 via-purple-600 to-blue-700 flex justify-center items-center p-5 md:p-10 relative overflow-hidden">
            ...
            <div className="max-w-6xl w-full text-center relative z-10 animate-fade-in-up">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 mb-12">
                    <Link 
                        to="/ashraf" 
                        className="bg-white rounded-3xl p-6 md:p-8 text-decoration-none transform transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl border-t-4 border-yellow-400 relative overflow-hidden group"
                    >
                        <div className="absolute top-5 right-5 bg-gradient-to-r from-yellow-400 to-yellow-500 text-white px-4 py-1 rounded-full text-xs font-bold uppercase tracking-wider animate-pulse">
                            Featured
                        </div>
                        <div className="text-5xl mb-4 filter drop-shadow-md animate-float">
                            🌟
                        </div>
                        <h2 className="text-2xl font-extrabold text-gray-800 mb-3 bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent">
                            Ashraf's Ballot
                        </h2>
                        <p className="text-gray-600 text-sm md:text-base font-medium leading-relaxed">
                            Premium voting interface with party symbols and multilingual support
                        </p>
                    </Link>
